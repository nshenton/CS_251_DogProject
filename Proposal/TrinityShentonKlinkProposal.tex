...
%\todo{use cv to get hyperparameters, look into weighted hyperparameters}\\
%\todo{work on memory issue possibly the vacc, get working on the vacc - scale up}\\
%\todo{have a tool online where there is a drag and drop image.  Build a unity app?  Or Html webpage
